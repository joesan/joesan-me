...
Hugo, Gatsby, Octopress, Wordpress, Sitegen, Medium, Zola were some platforms that I explored and decided to go with Zola. Well first, I liked the idea
...
second thought, I decided to give Zola a try. It was the easiest thing to do in this world. Just 3 commands, and your static site is up and running. It took my about
20 minutes, yes, just under 20 minutes to try out Zola, choose a theme, get it up and running on my local machine.
...
that as it makes sense to have such automation in a team set up.
